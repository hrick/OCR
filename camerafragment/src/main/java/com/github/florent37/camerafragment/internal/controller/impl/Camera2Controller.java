...
public class Camera2Controller implements CameraController<String>,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        camera2Manager.initializeCameraManager(configurationProvider, context, null);
    ...
    public Size getSizePreview() {
        return camera2Manager.getSizePreview();
    }

    @Override
    public boolean zoom(int level) {
        return camera2Manager.zoom(level);
    }

    @Override
    public void requestFocus(MotionEvent event) {
        camera2Manager.requestFocus(event);
    }
    ...
    @Override
    public void onCameraOpen(String closedCameraId) {
        camera2Manager.openCamera(currentCameraId, this);
    }
