...
public class FlashSwitchView extends ImageButton {
    ...
    public FlashSwitchView(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
        flashOnDrawable = ContextCompat.getDrawable(context, R.drawable.ic_lanterna_on);
        flashOffDrawable = ContextCompat.getDrawable(context, R.drawable.ic_lanterna_off);
    ...
    public void displayFlashOff() {
        setImageResource(R.drawable.ic_lanterna_off);
    }

    public void displayFlashOn() {
        setImageResource(R.drawable.ic_lanterna_on);
    }
