...
public class Camera1Controller implements CameraController<Integer>,
    ...
    public boolean zoom(int level) {
        return cameraManager.zoom(level);
    }

    @Override
    public void requestFocus(MotionEvent event) {
        cameraManager.requestFocus(event);
    }

    @Override
    public void onCreate(Bundle savedInstanceState) {
        cameraManager = new Camera1Manager();
        cameraManager.initializeCameraManager(configurationProvider, context, this);
    ...
    public Size getSizePreview() {
        return cameraManager.getSizePreview();
    }
...
//        cameraManager.openCamera(currentCameraId, this);
    ...
    @Override
    public void onCameraOpen(Integer closedCameraId) {
        cameraManager.openCamera(currentCameraId, this);
    }
    ...
    @Override
    public void onPhotoStart(CameraFragmentResultListener callback) {
        cameraView.onPhotoStart(callback);
    }

    @Override
    public void onManualFocus(CameraFragmentResultListener callback) {
        cameraView.onManualFocus(callback);
    }
